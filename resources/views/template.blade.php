					...
					<div class="row">
						<div class="col-md-4">
							<div class="company-desc">
								<strong>Edara Consult</strong>
								is a business transformation technology consultancy firm.
							</div>
							<div class="company-desc with-bg">
								<div class="content">We specialise in assisting companies improve and achieve their desired sustainable business performance and business value.</div>
								<div class="bg"></div>
							</div>
						</div>
						<div class="col-md-8 cta">
							<div class="content">
								<blockquote>
									...
									<cite>Simple yet a globally accepted business thrust in any strategy focused corporation.</cite>
								</blockquote>
							</div>
							<div class="bg"></div>
						</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="capabilities">
								<h3 class="title">Our Capabilities</h3>
								<ul>
									<li class=""><a href="<?php echo url('/corporate-strategy'); ?>">Corporate Strategy</a></li>
									<li class=""><a href="<?php echo url('/growth-strategy'); ?>">Growth Strategy</a></li>
									<li class=""><a href="<?php echo url('/transformation-management'); ?>">Transformation Management</a></li>
									<li class=""><a href="<?php echo url('/customer-strategy'); ?>">Customer Strategy</a></li>
									<li class=""><a href="<?php echo url('/customer-services-management'); ?>">Customer Services Management</a></li>
									<li class=""><a href="<?php echo url('/management-control-systems'); ?>">Management Control Systems</a></li>
									<li class=""><a href="<?php echo url('/organization-design'); ?>">Organization Design</a></li>
									<li class=""><a href="<?php echo url('/performance-improvement'); ?>">Performance Improvement</a></li>
									<li class=""><a href="<?php echo url('/project-management'); ?>">Project Management</a></li>
									<li class=""><a href="<?php echo url('/it-consulting-enterprise-application'); ?>">IT Consulting &amp; Enterprise Application</a></li>
									<li class=""><a href="<?php echo url('/training-workshops'); ?>">Training &amp; Workshops</a></li>
									<li class=""><a href="<?php echo url('/virtual-office'); ?>">Virtual Administrative Office Services</a></li>
									<li class=""><a href="<?php echo url('/accounting-financial'); ?>">Accounting &amp; Financial Services</a></li>
									<li class=""><a href="<?php echo url('/administrative'); ?>">Administrative Services</a></li>                
								</ul>
							</div>
						...
						<div class="col-md-8">
							...
							<div class="col-md-4">
								<div class="content-container">
									<p class="bottommargin-10">
										<strong>
											Complimentary Consultation &amp; Advisory Services
										</strong>
									</p>
									<p>You may also want to consider our free consulting advisory service that offer you personalized advice. We can help identify key issues of your current concerns.</p>
									<a href="<?php echo url('/question'); ?>" data-easing="easeInOutExpo" data-speed="1250" data-offset="60" class="button button-dark button-black nomargin">Got a Question?</a>
								</div>
							</div>
						</div>
					</div>
